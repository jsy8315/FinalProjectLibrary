...
--함수, 함수는 중첩가능
--SUBSTR(string, position, lengh): 지정한 위치position에서 length길이만큼 부분 문자열을 반환
...
--Multi table INSERT : 테이블에 N행 삽입
INSERT ALL
    INTO DEPT(DEPTNO, DNAME, LOC) VALUES(55, 'Multi', 'INSERT1')
    INTO DEPT (DEPTNO, DNAME, LOC) VALUES(66, 'Multi', 'INSER2')
SELECT 1 FROM DUAL;
...
--UPDATE
UPDATE DEPT SET DNAME = 'T연구소', LOC = '인천' WHERE DEPTNO = 10;
SELECT * FROM DEPT;
ROLLBACK;
